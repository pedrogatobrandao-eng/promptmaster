  ...
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:#111122;border:1px solid rgba(168,85,247,0.2);border-radius:12px;padding:32px;margin-bottom:24px;">
      ...
      <div style="background:#0d0d1a;border:1px solid rgba(168,85,247,0.3);border-radius:8px;padding:20px;text-align:center;margin-bottom:24px;">
        <p style="color:#5a5a72;font-size:11px;margin:0 0 8px;">SEU CÓDIGO DE ACESSO</p>
      ...
      <ol style="color:#9a9ab0;font-size:13px;line-height:2;margin:0 0 24px;padding-left:20px;">
        ...
        <li>Clique em <strong style="color:#e8e6f0;">authenticate</strong></li>
      </ol>
    ...
    <div style="text-align:center;margin-bottom:32px;">
      <a href="https://promptmaster-3n3w.vercel.app" style="background:#a855f7;color:#fff;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:700;font-size:14px;">🚀 ACESSAR O CURSO AGORA</a>
    </div>
    <div style="text-align:center;">
      <p style="color:#3a3a52;font-size:11px;">suporte: zeroaoluxo01@gmail.com</p>
    </div>
  </div>
</body>
</html>`
